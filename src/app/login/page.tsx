    ...
    <div className="text-neutral-text-light min-h-screen overflow-hidden" style={{ background: 'linear-gradient(to bottom, #222 0%, #29CEF2 100%)' }}>
      ...
      <main className="text-white min-h-screen">
        ...
        <section className="py-24 px-6 md:px-16" style={{ background: 'linear-gradient(to bottom, #222 0%, #29CEF2 50%, #000 100%)' }}>
          <div className="max-w-[500px] mx-auto bg-gray-900 p-8 rounded-lg shadow-lg">
            <h2 className="text-3xl font-bold text-center mb-8">Sign In</h2>
            <form>
              <div className="mb-6">
                <input type="email" placeholder="Your Email" className="bg-gray-800 p-4 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#29CEF2]" />
              </div>
              <div className="mb-6">
                <input type="password" placeholder="Password" className="bg-gray-800 p-4 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#29CEF2]" />
              </div>
              <div className="text-center">
                <button type="submit" className="px-8 py-3 bg-white text-black font-bold rounded hover:bg-gray-200 transition w-full">
                  Sign In
                </button>
              </div>
            </form>
