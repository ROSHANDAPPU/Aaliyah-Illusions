...
function PrintCard({ src, alt, index }: { src: string; alt: string; index: number }) {
    ...
    >
      ...
      >
        <div className="w-14 h-14 rounded-full border border-[#29CEF2]/60 flex items-center justify-center backdrop-blur-sm bg-black/30">
          <svg className="w-6 h-6 text-[#29CEF2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function OnSitePrintingPortfolio() {
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#050505" }}>
      ...
      <main className="text-white min-h-screen">
        ...
        <section className="relative h-screen flex items-end overflow-hidden" style={{ backgroundColor: "#050505" }}>
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1559030624-a4625b3a6289?w=1800&q=90&fit=crop"
              alt="On-Site Printing Hero"
              fill
              priority
          ...
          <div className="absolute inset-0 z-[2] pointer-events-none" style={{
            background: "radial-gradient(ellipse 110% 75% at 50% 40%, rgba(41,206,242,0.06) 0%, transparent 60%)"
          }} />
          ...
          >
            ...
            >
              INSTANT<br />
              <span style={{ WebkitTextStroke: "2px rgba(255,255,255,0.35)", color: "transparent" }}>MEMORIES</span>
            </h1>
            ...
            <div className="mt-10 flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-12">
              ...
              <p className="text-white/50 text-xs tracking-[0.28em] uppercase font-light">
                Printed Live, Cherished Forever
              </p>
          ...
          <div className="absolute bottom-[4.5rem] left-0 right-0 z-10 overflow-hidden py-3 border-t border-white/5">
            ...
            >
              {Array(6).fill("EVENT PRINTING  •  PHOTO BOOTHS  •  INSTANT PRINTS  •  SOUVENIR PHOTOS  •  BRAND ACTIVATIONS  •  ").join("")}
            </div>
          </div>
        ...
        <section className="px-6 md:px-16 pt-16 pb-32" style={{ backgroundColor: "#050505" }}>
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="border-t border-white/5 pt-10 flex items-center justify-between mb-12">
              <p className="text-[10px] tracking-[0.3em] uppercase text-white/25">Our Printing Work</p>
            ...
            <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
              {portfolioImages.map((src, idx) => (
                <div key={idx} className="break-inside-avoid mb-4">
                  <PrintCard src={src} alt={`On-site printing work ${idx + 1}`} index={idx} />
                </div>
              ))}
            </div>
          </div>
