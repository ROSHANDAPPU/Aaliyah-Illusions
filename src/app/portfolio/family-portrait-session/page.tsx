...
const images = [
  "https://images.pexels.com/photos/28276625/pexels-photo-28276625.jpeg",
...
export default function FamilyPortraitSession() {
        ...
        <section className="h-screen flex" style={{ backgroundColor: '#000' }}>
          ...
          <div className="w-1/2 relative">
            <video
              ...
              playsInline
            >
              <source src="/corporate/6396005-hd_1080_1920_25fps.mp4" type="video/mp4" />
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/50">
              ...
              <p className="text-xl text-gray-300 mb-8 iceland-font text-center px-12">
                Capturing authentic family moments through warm, cinematic storytelling
              </p>
              <a href="/portfolio/family-portrait-videography" className="text-[10px] font-light tracking-[0.2em] uppercase text-white border border-white/20 px-6 py-2 hover:border-[#29CEF2] hover:text-[#29CEF2] transition-colors">
                VIEW VIDEOS
              </a>
            </div>
          </div>
          ...
          <div className="w-1/2 relative">
            <Image
              src="https://images.pexels.com/photos/28276625/pexels-photo-28276625.jpeg"
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/50 px-12 text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 iceland-font">
                Professional photography preserving genuine family bonds and emotions
              </p>
              <a href="/portfolio/family-portrait-photography" className="text-[10px] font-light tracking-[0.2em] uppercase text-white border border-white/20 px-6 py-2 hover:border-[#29CEF2] hover:text-[#29CEF2] transition-colors">
                VIEW PHOTOS
              </a>
            </div>
          </div>
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
              {images.map((image, idx) => (
                <div key={idx} className="break-inside-avoid overflow-hidden rounded-lg">
                  <Image
                    src={image}
                    alt={`Family portrait image ${idx + 1}`}
                    width={400}
                    height={300}
