...
const images = [
  ...
  "https://images.unsplash.com/photo-1610945264803-c22b62d2a7b3?w=500&h=400&fit=crop",
...
export default function BrandIdentityLaunch() {
        ...
        <section className="h-screen flex" style={{ backgroundColor: '#000' }}>
          ...
          <div className="w-1/2 relative">
            <video
              ...
              playsInline
            >
              <source src="/corporate/6396113-hd_1080_1920_25fps.mp4" type="video/mp4" />
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/50">
              ...
              <p className="text-xl text-gray-300 mb-8 iceland-font text-center px-12">
                Telling your brand story through compelling, high-production visual content
              </p>
              <a href="/portfolio/brand-identity-videography" className="text-[10px] font-light tracking-[0.2em] uppercase text-white border border-white/20 px-6 py-2 hover:border-[#29CEF2] hover:text-[#29CEF2] transition-colors">
                VIEW VIDEOS
              </a>
            </div>
          </div>
          ...
          <div className="w-1/2 relative">
            <Image
              src="https://images.pexels.com/photos/7661627/pexels-photo-7661627.jpeg"
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/50 px-12 text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 iceland-font">
                Meticulous photography crafting a visual identity that resonates with heritage and modernity
              </p>
              <a href="/portfolio/brand-identity-photography" className="text-[10px] font-light tracking-[0.2em] uppercase text-white border border-white/20 px-6 py-2 hover:border-[#29CEF2] hover:text-[#29CEF2] transition-colors">
                VIEW PHOTOS
              </a>
            </div>
          </div>
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
              {images.map((image, idx) => (
                <div key={idx} className="break-inside-avoid overflow-hidden rounded-lg">
                  <Image
                    src={image}
                    alt={`Brand identity image ${idx + 1}`}
                    width={400}
                    height={300}
