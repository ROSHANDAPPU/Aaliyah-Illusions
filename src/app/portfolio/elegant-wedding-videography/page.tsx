...
const videos = [
  "/wedding-videos/8775885-uhd_3840_2160_25fps.mp4",
  "/wedding-videos/8776998-uhd_2160_3840_25fps.mp4",
  "/wedding-videos/8777008-uhd_2160_3840_25fps.mp4",
  "/wedding-videos/12526902_2160_3840_30fps.mp4",
  "/wedding-videos/14619084_3840_2160_25fps.mp4",
  "/wedding-videos/14620261_3840_2160_30fps.mp4",
  "/wedding-videos/7268830-uhd_4096_2160_25fps.mp4",
  "/wedding-videos/12526922_2160_3840_30fps.mp4",
  "/wedding-videos/13255030_1920_1080_50fps.mp4",
  "/wedding-videos/14620228_3840_2160_30fps.mp4",
];

export default function ElegantWeddingVideography() {
    ...
    <div className="text-neutral-text-light min-h-screen overflow-hidden" style={{ backgroundColor: '#000' }}>
      ...
      <main className="text-white min-h-screen">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden" style={{ backgroundColor: '#050505' }}>
          ...
          >
            <p className="text-[10px] tracking-[0.4em] uppercase text-[#29CEF2]/80 mb-6 font-medium">[ Wedding Videography ]</p>
            <h1
            ...
            <div className="mt-10 flex items-center justify-center gap-6">
              ...
              <p className="text-white/50 text-xs tracking-[0.28em] uppercase font-light">Stories in Motion, Emotions in Frame</p>
              <div className="w-12 h-[1px] bg-[#29CEF2]/50" />
            </div>
          </div>
