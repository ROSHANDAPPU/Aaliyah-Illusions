...
export default function BrandIdentityVideography() {
    ...
    <div className="text-neutral-text-light min-h-screen overflow-hidden" style={{ backgroundColor: '#000' }}>
      ...
      <main className="text-white min-h-screen">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden" style={{ backgroundColor: '#050505' }}>
          ...
          >
            <p className="text-[10px] tracking-[0.4em] uppercase text-[#29CEF2]/80 mb-6 font-medium">[ Brand Identity Videography ]</p>
            <h1
            ...
            <div className="mt-10 flex items-center justify-center gap-6">
              ...
              <p className="text-white/50 text-xs tracking-[0.28em] uppercase font-light">Telling Your Brand Story</p>
              <div className="w-12 h-[1px] bg-[#29CEF2]/50" />
            </div>
          </div>
