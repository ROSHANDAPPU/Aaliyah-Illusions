...
const images = [
  ...
  "https://images.pexels.com/photos/7661627/pexels-photo-7661627.jpeg",
  "https://images.unsplash.com/photo-1524222724992-2202b3734142?w=500&h=400&fit=crop",
  "https://images.unsplash.com/photo-1559030624-a4625b3a6289?w=500&h=400&fit=crop",
];

export default function ProductLaunchCampaign() {
    ...
    <div className="text-neutral-text-light min-h-screen overflow-hidden" style={{ backgroundColor: '#000' }}>
      ...
      <main className="text-white min-h-screen">
        ...
        <section className="h-screen flex" style={{ backgroundColor: '#000' }}>
          ...
          <div className="w-1/2 relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/50">
              ...
              <p className="text-xl text-gray-300 mb-8 iceland-font text-center px-12">
                Capturing the energy of brand launches, behind-the-scenes action, and compelling product showcases through cinematic videography
              </p>
              <a href="/portfolio/product-launch-videography" className="text-[10px] font-light tracking-[0.2em] uppercase text-white border border-white/20 px-6 py-2 hover:border-[#29CEF2] hover:text-[#29CEF2] transition-colors">
                VIEW VIDEOS
              </a>
            </div>
          </div>
          ...
          <div className="w-1/2 relative">
            <Image
              src="https://images.pexels.com/photos/4041391/pexels-photo-4041391.jpeg"
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/50 px-12 text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 iceland-font">
                Professional product shoots, behind-the-scenes brand photography, and event coverage that elevates your brand identity
              </p>
              <a href="/portfolio/product-launch-photography" className="text-[10px] font-light tracking-[0.2em] uppercase text-white border border-white/20 px-6 py-2 hover:border-[#29CEF2] hover:text-[#29CEF2] transition-colors">
                VIEW PHOTOS
              </a>
            </div>
          </div>
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
              {images.map((image, idx) => (
                <div key={idx} className="break-inside-avoid overflow-hidden rounded-lg">
                  <Image
                    src={image}
                    alt={`Product launch image ${idx + 1}`}
                    width={400}
                    height={300}
