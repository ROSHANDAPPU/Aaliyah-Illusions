...
export default function FamilyPortraitPhotography() {
        ...
        <section className="relative h-screen flex items-end overflow-hidden" style={{ backgroundColor: '#050505' }}>
          <div className="absolute inset-[-8%] z-0" style={{ transform: `translateY(${parallaxOffset}px)` }}>
            <Image
              ...
              alt="Family Portrait Photography Hero"
              fill priority
          ...
          >
            <p className="text-[10px] tracking-[0.4em] uppercase text-[#29CEF2]/80 mb-6 font-medium">[ Family Portrait Photography ]</p>
            <h1
            ...
            <div className="mt-10 flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-12">
              ...
              <p className="text-white/50 text-xs tracking-[0.28em] uppercase font-light">Preserving Genuine Family Bonds</p>
            </div>
          </div>
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
              {images.map((image, idx) => (
                <div key={idx} className="break-inside-avoid overflow-hidden rounded-lg">
                  <Image
                    src={image}
                    alt={`Family portrait photo ${idx + 1}`}
                    width={400}
                    height={300}
